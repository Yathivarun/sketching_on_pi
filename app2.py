...
# ---------------- DISPLAY (FIXED) ----------------
time.sleep(2)  # Allow window manager to stabilize
...
def overlay_id(img, text):
    overlay = img.copy()
    cv2.rectangle(overlay, (int(SCREEN_W*0.73), int(SCREEN_H*0.93)),
                  (int(SCREEN_W*0.99), SCREEN_H), (0, 0, 0), -1)
